...
>
> Continue H4 formal art integration from the staged import checkpoint. Keep `miniprogram/` as the stable uploadable client during migration. Other absolute paths below are historical machine records.
