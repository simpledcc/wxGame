...
>
> H4 formal art integration and H8.4/H8.5 preparation-page visual refinements are complete. Continue with Phase 9 two-real-phone preparation-flow QA while keeping `miniprogram/` as the stable uploadable client during migration. Other absolute paths below are historical machine records.
