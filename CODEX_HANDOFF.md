...
>
> H4 baseline integration and H8.4/H8.5 preparation-page visual refinements are complete. A high-fidelity H4 resource upgrade is now in progress after soft rendering was reported on a second Creator computer. Finish the controlled Creator reimport/build before Phase 9 two-real-phone preparation-flow QA. Keep `miniprogram/` as the stable uploadable client during migration. Other absolute paths below are historical machine records.
