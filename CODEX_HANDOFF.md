...
>
> H4 baseline integration, high-fidelity resource upgrade and H8.4-H8.6 preparation-page visual refinements are complete. The next release gate is Phase 9 two-real-phone preparation-flow QA. Keep `miniprogram/` as the stable uploadable client during migration. Other absolute paths below are historical machine records.
