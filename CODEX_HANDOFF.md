...
>
> H4 formal art integration is complete. Continue with Phase 9 two-real-phone preparation-flow QA while keeping `miniprogram/` as the stable uploadable client during migration. Other absolute paths below are historical machine records.
