...
- H4 formal Home art is `imported`: five generated masters, 18 optimized runtime files (`335,229` bytes), 23 Creator metadata files, nine archived reference images, a composition preview, runtime semantic bindings and cross-computer verifier tools are present. `home_common` builds as a declared WeChat subpackage.
